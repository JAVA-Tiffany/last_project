...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<div class="login100-pic js-tilt" data-tilt>
					...
					<img
						src="resources/images/80678738_2416624028588147_5452304186879982403_n.jpg"
						alt="IMG">
				</div>
				...
				<form class="login100-form validate-form" action="loginchk"
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn-naver"
							onclick="location.href='${url }'">Naver 회원가입</button>
					</div>

					<div class="container-login100-form-btn">
						<button class="login100-form-btn-facebook"
							onclick="google_login()">GOOGLE 회원가입</button>
					</div>


					<div class="text-center p-t-136">
						<a class="txt2" href="join"> Create your Account <i
							class="fa fa-long-arrow-right m-l-5" aria-hidden="true"></i>
						</a>
					</div>
					<div class="text-center p-t-136">
						<a class="txt2" href="infosearch"> Find ID or PW <i
							class="fa fa-long-arrow-right m-l-5" aria-hidden="true"></i>
						</a>
					</div>
				</form>
	...
	<form method='post' name='frm' action="https://accounts.google.com/logout" target="ifrm">
		<input type="submit" id="google_logout" style="display: none">
	</form>
