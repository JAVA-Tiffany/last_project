package com.project.controller.kr.co.bootpay.javaApache;

import com.google.gson.Gson;
import com.project.controller.kr.co.bootpay.javaApache.model.request.Cancel;
import com.project.controller.kr.co.bootpay.javaApache.model.request.RemoteForm;
import com.project.controller.kr.co.bootpay.javaApache.model.request.SubscribeBilling;
...
public class Test {
    ...
    public static void main(String[] args) {
        api = new BootpayApi("5efe7c794f74b40021f2c0f5", "UntlOb7X9XL75StXrTfPy6DYfwmZuvxGEBl8YEizDLw=");
        goGetToken();
        goVerfity();
        goCancel();
        goSubscribeBilling();
